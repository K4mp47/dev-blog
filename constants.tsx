...
export const SIDEBAR_STRUCTURE: SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'iPhone Animation with Spline', id: 'iphone-spline-animation' },
    ]
  },
  {
    title: 'Backgrounds',
...
export default function Home() {
  ...
  {
    id: 'iphone-spline-animation',
    title: 'iPhone Animation with Spline',
    description: 'Interactive iPhone animation effect using Spline 3D models within a Next.js application.',
    link: 'https://github.com/k4mp47/iphone-animation',
    ...
    duration: 'Medium',
    intro: {
      content: "This project demonstrates an interactive iPhone animation effect using Spline 3D models within a Next.js application. It features a two-column layout with scrollable text content on the left and a fixed 3D Spline model on the right."
    },
    setup: {
      items: [
        { type: 'text', content: "First of all, create the next project and import the required dependencies:" },
        { type: 'command', content: "npx create-next-app@latest" },
        { type: 'command', content: "npm install @splinetool/react-spline" },
        { type: 'text', content: "First, run the development server:" },
        { type: 'command', content: "npm run dev" },
        { type: 'text', content: "Open http://localhost:3000 with your browser to see the result." }
      ]
    },
    implementation: {
      description: "The implementation involves integrating Spline 3D models into a Next.js app with a responsive two-column layout.",
      principles: ["Spline 3D Integration", "Two-Column Layout", "Scrollable Text Content", "Custom Font"],
      files: [
        {
          name: "app/layout.tsx",
          language: "tsx",
    ...
    <html lang="en">
      ...
      >
        ...
        },
        {
          name: "app/page.tsx",
          language: "tsx",
          code: `import Model from "@/components/Spline";
...
export default config`
    ...
    conclusion: {
      content: "This project uses next/font to automatically optimize and load fonts, specifically Geist and Spline Sans Mono.",
      author: "Alberto"
    },
    relatedTutorialIds: []
  }
